      ...
      if ( serial_type <= 7 && serial_type > 0 )
      {
        ...
        if ( serial_type == 7 )
        {
          //Debug.Assert( sizeof( v) == sizeof(pMem.r));
                ...
                //TODO: - Fix
            var result = BitConverter.GetBytes(pMem.r);
            v = (ulong)BitConverter.ToInt64(result, 0);
#else
...
swapMixedEndianFloat(x);
              ...
              var result = BitConverter.GetBytes((long)x);
                pMem.r = BitConverter.ToDouble( result, 0 );// memcpy(pMem.r, x, sizeof(x))
#else
